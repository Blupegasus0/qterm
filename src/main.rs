    ...
    for i in 0..3 {
        match info_color {
            "grey" | "gray" => {
                println!(
                    "{} {} {}",
                    time_strs[i].bold().bright_black(),
                    cpu_strs[i].bold().bright_black(),
                    ram_strs[i].bold().bright_black()
                );
            }
            "black" => {
                println!(
                    "{} {} {}",
                    time_strs[i].bold().black(),
                    cpu_strs[i].bold().black(),
                    ram_strs[i].bold().black()
                );
            }
            "magenta" => {
                println!(
                    "{} {} {}",
                    time_strs[i].bold().magenta(),
                    cpu_strs[i].bold().magenta(),
                    ram_strs[i].bold().magenta()
                );
            }
            "cyan" => {
                println!(
                    "{} {} {}",
                    time_strs[i].bold().cyan(),
                    cpu_strs[i].bold().cyan(),
                    ram_strs[i].bold().cyan()
                );
            }
            "yellow" => {
                println!(
                    "{} {} {}",
                    time_strs[i].bold().yellow(),
                    cpu_strs[i].bold().yellow(),
                    ram_strs[i].bold().yellow()
                );
            }
            "green" => {
                println!(
                    "{} {} {}",
                    time_strs[i].bold().green(),
                    cpu_strs[i].bold().green(),
                    ram_strs[i].bold().green()
                );
            }
            "blue" => {
                println!(
                    "{} {} {}",
                    time_strs[i].bold().blue(),
                    cpu_strs[i].bold().blue(),
                    ram_strs[i].bold().blue()
                );
            }
            "red" => {
                println!(
                    "{} {} {}",
                    time_strs[i].bold().red(),
                    cpu_strs[i].bold().red(),
                    ram_strs[i].bold().red()
                );
            }
